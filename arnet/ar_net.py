...
def main(verbose=False):
    ...
    if created_ar_data:
        print("ar params", nice_print_list(ar_params))
    print("model weights", nice_print_list(coeff))
    # should be [0.20, 0.30, -0.50, ...]

    if created_ar_data:
        plot_weights(ar_val=len(ar_params[0]), weights=coeff[0], ar=ar_params[0], save=save, savedir=results_path)
